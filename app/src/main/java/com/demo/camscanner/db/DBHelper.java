package com.demo.camscanner.db;
...
//lớp DBHelper sẽ tạo một database với tên DATABASE_NAME nếu nó chưa tồn tại, hoặc mở một database đã tồn tại với tên đó.
    public DBHelper(Context context) {
        // đối tượng Context trong Android, chứa thông tin về môi trường chạy của ứng dụng.
        //DATABASE_NAME: là một biến toàn cục đã được định nghĩa trước đó, chứa tên của database.
        //SQLiteDatabase.CursorFactory: là một interface trong SQLite cho phép tạo một Cursor với đặc tính tùy chọn.
        // giá trị được truyền vào là null, tức là sẽ sử dụng cursor mặc định của SQLite.
        //1: là một số nguyên, là phiên bản của database.
