...
import com.demo.camscanner.BuildConfig;
...
public class AdmobAds {
    public static String PKG_APP = "com.demo.camscanner";
...
//                        AdmobAds.populateNativeAdView(nativeAd, nativeAdView);// bỏ quảng ở phần save
